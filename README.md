...
-------------------------------
Обновление MBR Recovery 1.1.0 от 17.07.2023

[+]  Асинхронное выполнение резервного копирования и восстановления MBR.

[+] Некоторые фиксы багов. 

[+] В настройках добавлена новая функция "Запускать MBR Recovery вместе с Windows"
